...
# MAJOR UPDATE LARSDOKU CAN NOW FORGE PUZZZLES AND UNSOLVABLES VIA MASKS AND WE ARE IN THE PROGRESS
# OF MAKING LARSDOKU USING MASKS ONLY TO BETTER SUIT ITS USE AS A REESEARCH APPLICATIOM FOR FINDING NEW TECHINQUES
# VIA BASE MASKS AND TECHNIQUES. UPDATE ARRIVING SHORTY, VIA THIS YOU CAN FIND THE COMPLETE TECHNIQUES FOR
# YOUR PUZZLE MASK AND FIND OTHER PUIZZLES WITH THE SAME MASK. THIS HELPS WITH PATTERN RECOGNITION FOR TECHNIOQUE
# RESEARCH AND FINDING!! WITH OVER 500 THOUSAND UNIQUE BASE MASKS (UPODATING TO  ONE MILLION SOON ) THAT ARE **UNSOLVABLE** 
# TO HELP YOU FIND THE MISSING OR NEW TECHINQUES YOU NEED FOR YOUR SOLVER!!!

## MAJOR UPDATE COMING SHORTLY: YOU USE CAN USE LARSDOKU TO FORGE NEW UNSOLVABLE MASKS AND FIND NEW TECHINQUES FOR YOUR SOLVER.
