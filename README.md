...
# MAJOR UPDATE LARSDOKU CAN NOW FORGE PUZZZLES AND UNSOLVABLES VIA TECHNIQUE SIGNATURES AND WE ARE
...
# FINDING!! WITH OVER 10 THOUSAND UNIQUE TECHINQUE SIGNATURES  (UPODATING TO  ONE MILLION SOON )
...
## MAJOR UPDATE COMING SHORTLY: YOU USE CAN USE LARSDOKU TO FORGE NEW UNSOLVABLES VIA A TECHNIQUE
##  SIGNATURE AND FIND NEW TECHINQUES FOR YOUR SOLVER. FORGINGG A NEW UNSOLVABLE MASK FROM THESE
##  10K SIGNATURES RESULTS IN A NEW MASK NOT IN OUR DATABASE OF ONE MILLION UNSOLVABLE MASKS.
##  THE TOOLS WE USE TO FORGE NEW MASKS IS UPCOMING SHORTLY
